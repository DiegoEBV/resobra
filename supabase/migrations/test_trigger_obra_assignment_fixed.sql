...
-- Insertar una obra de prueba usando solo las columnas que existen
INSERT INTO obras (
    nombre,
    descripcion,
    ubicacion,
...
-- Verificar el estado general de todas las asignaciones
SELECT 
    'Total de obras' as descripcion,
    COUNT(*) as cantidad
FROM obras
UNION ALL
SELECT 
...
UNION ALL
SELECT 
    'Total de asignaciones user_obras' as descripcion,
    COUNT(*) as cantidad
FROM user_obras;